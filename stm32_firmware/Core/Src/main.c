...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : PID Cascada + Filtro Complementario + Trim Dinamico
  ******************************************************************************
  */
...
static float Kp_angle = 2.0f;       

static float Kp = 0.80f;
static float Ki = 0.15f;
static float Kd = 0.00f;
static float gx_sp = 0.0f;          

// Trim Dinámico para motores 1 y 4
...
/* Mixer con Signos Corregidos y Trim Dinámico */
